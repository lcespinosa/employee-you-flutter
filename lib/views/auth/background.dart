          ...
          new Stack(
            ...
            children: <Widget>[
              if (MediaQuery.of(context).orientation == Orientation.portrait)
                Image.asset('assets/images/user-login-logo.png', width: MediaQuery.of(context).size.width/2,),
              if (MediaQuery.of(context).orientation == Orientation.landscape)
                Image.asset('assets/images/user-login-logo.png', width: MediaQuery.of(context).size.height/3,),
              WavyHeader(),
            ],
          ),
          Expanded(
