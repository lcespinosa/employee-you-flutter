...
class Styles {
  ...
  static const Color gradientPrimaryColor = Color.fromRGBO(155, 81, 224, 1);
  static const Color gradientLastColor = Color.fromRGBO(190, 153, 224, 1.0);
  ...
  static const Color commonDarkGradient = Colors.blueGrey;
  ...
  static TextStyle displayCounter = defaultStyle.copyWith(
    fontSize: 30.0,
    fontFamily: 'Orbitron',
  );
  ...
  static const Color matchWonCardSideColor = Color.fromRGBO(22, 160, 133, 1);
  static const Color matchLostCardSideColor = Color.fromRGBO(211, 84, 0, 1);
